    ...
    var onSubmitClick = function() {
        if (currentQuestion.isCorrect()) {
            ...
            $(star_selector).fadeOut(function() {
                $(this).addClass("right-answer").fadeIn();
            });
            console.log("Answer is correct");
        } else {
            $submitAnswer.hide();
            $continue.show();
            var selector = "input[value=\"" + currentQuestion.correctChoice + "\"]";
            console.log(selector);
            $(selector).parent().addClass("highlight");
