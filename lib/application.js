$(document).ready(function() {
    ...
    $.getJSON("data/questions.json", function(json) {
        var questions = $.map(json, function(element, index) {
            return $.extend(new Question(), element);
        });

        // Create quiz with a set of questions
        Quiz(questions).onReady();
    });
});
...
var Quiz = function(questions) {
    ...
    var onSubmitClick = function() {
        ...
        // Ignore event if an animation is running
        if ($(".star:animated").length > 0) {
            console.log("Animation still going on. Click event ignored.");
            return;
        }
        ...
        if (currentQuestion.isCorrect()) {
            ...
            $(star_selector).fadeOut(function() {
                ...
                $(this).addClass("highlight").fadeIn(function() {
                    ...
                    console.log("displayNextQuestion from onSubmitClick");
                    displayNextQuestion();
    ...
    var onContinueClick = function() {
        ...
        console.log("displayNextQuestion from onContinueClick");
        displayNextQuestion();
    };
