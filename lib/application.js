...
function QuizModel(questions) {
    ...
    this.updateCorrectAnswerText = function(element) {
        // Correct answer isn't displayed until a wrong answer is submitted
        // This avoids revealing the right answer in advance
        var oldValue = $(element).text();
        return self.wrongAnswerSubmitted() ? self.currentQuestion().correctChoice : oldValue;
    };
